...
## [v2.0.2](https://github.com/happytodev/blogr/compare/v2.0.1...v2.0.2) - 2026-07-08
...
- **Blog posts**: corrupted `photo` values in `draft_data` (PHP arrays instead of strings) no longer cause TypeError on edit page load (#265)
