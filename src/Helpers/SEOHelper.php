...
class SEOHelper
{
    ...
    public static function forListingPage(string $type = 'index', ?string $name = null, ?string $description = null): array
    {
        ...
        $baseTitle = $config['default_title'];
        $baseDescription = $description ?: $config['default_description'];
        ...
        switch ($type) {
            case 'category':
                if ($name) {
                    ...
                    $seo['keywords'] = "{$name}, " . $config['default_keywords'];
                }
                break;
    ...
    public static function forBlogPost(BlogPost $post): array
    {
        ...
        $seo = [
            ...
            'robots' => 'index, follow',
            'author' => $post->user->name ?? $config['site_name'],
        ...
        if ($post->photo) {
            ...
            $seo['image'] = asset($config['og']['image']);
            $seo['image_width'] = $config['og']['image_width'];
            $seo['image_height'] = $config['og']['image_height'];
        }
    ...
    public static function generateJsonLd(array $seoData): string
    {
        ...
        $baseSchema = [
            ...
            'name' => $seoData['title'] ?? $config['default_title'],
            'description' => $seoData['description'] ?? $config['default_description'],
