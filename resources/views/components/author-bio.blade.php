...
@else
    ...
    <div class="bg-[var(--color-primary)]/10 dark:bg-[var(--color-primary-dark)]/20 border-l-4 border-[var(--color-primary)] dark:border-[var(--color-primary-dark)] p-6 mb-8 mt-4 rounded-r-xl">
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            @else
                @if($showAvatar)
                <div class="w-20 h-20 rounded-full bg-gradient-to-br from-[var(--color-primary)] to-purple-600 flex items-center justify-center ring-4 ring-white dark:ring-gray-600 shadow-lg flex-shrink-0">
