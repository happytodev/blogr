...
<div {{ $attributes->merge(['class' => 'flex items-center space-x-4']) }}>
    ...
    <a href="{{ $feedUrl }}" target="_blank" rel="noopener noreferrer"
       class="text-gray-600 dark:text-gray-400 hover:text-[var(--color-primary-hover)] dark:hover:text-[var(--color-primary-hover-dark)] transition-colors inline-flex items-center justify-center p-1 min-w-[24px] min-h-[24px] focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus:outline-none rounded"
       title="RSS Feed">
    ...
    <a href="{{ $bluesky }}" target="_blank" rel="noopener noreferrer"
       class="text-gray-600 dark:text-gray-400 hover:text-[var(--color-primary-hover)] dark:hover:text-[var(--color-primary-hover-dark)] transition-colors inline-flex items-center justify-center p-1 min-w-[24px] min-h-[24px] focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus:outline-none rounded"
       title="Bluesky" aria-label="Bluesky">
        <svg class="{{ $size }}" fill="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ $mastodon }}" target="_blank" rel="noopener noreferrer me"
       class="text-gray-600 dark:text-gray-400 hover:text-[var(--color-primary-hover)] dark:hover:text-[var(--color-primary-hover-dark)] transition-colors inline-flex items-center justify-center p-1 min-w-[24px] min-h-[24px] focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus:outline-none rounded"
       title="Mastodon" aria-label="Mastodon">
        <svg class="{{ $size }}" fill="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ $substack }}" target="_blank" rel="noopener noreferrer"
       class="text-gray-600 dark:text-gray-400 hover:text-[var(--color-primary-hover)] dark:hover:text-[var(--color-primary-hover-dark)] transition-colors inline-flex items-center justify-center p-1 min-w-[24px] min-h-[24px] focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus:outline-none rounded"
       title="Newsletter (Substack)" aria-label="Newsletter (Substack)">
        <svg class="{{ $size }}" fill="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ $furaffinity }}" target="_blank" rel="noopener noreferrer"
       class="text-gray-600 dark:text-gray-400 hover:text-[var(--color-primary-hover)] dark:hover:text-[var(--color-primary-hover-dark)] transition-colors inline-flex items-center justify-center p-1 min-w-[24px] min-h-[24px] focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus:outline-none rounded"
       title="FurAffinity" aria-label="FurAffinity">
