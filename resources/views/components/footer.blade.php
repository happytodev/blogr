...
<footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 mt-auto transition-colors duration-200">
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ $linkedin }}" target="_blank" rel="noopener noreferrer" 
                   class="text-gray-600 dark:text-gray-400 hover:text-blue-700 dark:hover:text-blue-500 transition-colors"
                   title="LinkedIn">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ $facebook }}" target="_blank" rel="noopener noreferrer" 
                   class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 transition-colors"
                   title="Facebook">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-4 text-center text-xs text-gray-500 dark:text-gray-500">
            <span>Powered by <a href="https://github.com/happytodev/blogr" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Blogr</a></span>
        </div>
    </div>
</footer>
@endif
