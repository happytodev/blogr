    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div class="flex items-center space-x-4">
                @if(config('blogr.rss.show_in_footer', false) && config('blogr.rss.enabled', true))
                @php
                ...
                <a href="{{ $feedUrl }}" target="_blank" rel="noopener noreferrer"
                   class="text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors"
                   title="RSS Feed">
                ...
                @if($github = config('blogr.ui.footer.social_links.github'))
                ...
                @if($linkedin = config('blogr.ui.footer.social_links.linkedin'))
                ...
                @if($facebook = config('blogr.ui.footer.social_links.facebook'))
                ...
                @if($bluesky = config('blogr.ui.footer.social_links.bluesky'))
                ...
                @if($youtube = config('blogr.ui.footer.social_links.youtube'))
                ...
                @if($instagram = config('blogr.ui.footer.social_links.instagram'))
                ...
                @if($tiktok = config('blogr.ui.footer.social_links.tiktok'))
                ...
                @if($mastodon = config('blogr.ui.footer.social_links.mastodon'))
